		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-bar"></span>
				</a> <a class="brand" href="index.html"><span><img alt=""
						src="img/logo2.png" style="height: 60px;width: 80px"></span></a>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown"><a class="btn dropdown-toggle"
							data-toggle="dropdown" href="#"> <i
								class="halflings-icon white user"></i> ${student.student_name} <span
								class="caret"></span>
						</a>
							<ul class="dropdown-menu">
								<li class="dropdown-menu-title"><span>系统设置</span></li>
								<li><a href="student/toPay" target="u"><i
										class="halflings-icon user"></i> 学生付费</a></li>
					...
					$.ajax({
					type:"post",
					url:"student/toMain!studentSignIn",
					success:function(e){
					alert(e)
					}
					});
						...
						<button class="btn" id="signOn">学生签到</button>
				</div>
	...
	<div class="container-fluid-full">
		<div class="row-fluid">
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
							...
							<ul>
								<li><a class="submenu"
									href="student/toTransNotice!getNotice" target="u"><i
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
							...
							<ul>
								<li><a class="submenu"
									href="student/toFindStudentTime!findAllByCourseProject"
									target="u"><i class="icon-file-alt"></i><span
										class="hidden-tablet"> 查学时</span></a></li>
								<li><a class="submenu"
									href="student/toFindExam!findAllByCourseProject" target="u"><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											查考试</span></a></li>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
							...
							<ul>
								<li><a class="submenu"
									href="student/toSchoolEvaluationAction!selectAllFromSchool"
									target="u"><i class="icon-file-alt"></i><span
										class="hidden-tablet"> 评价驾校</span></a></li>
								<li><a class="submenu"
									href="student/toTeacherEvalution!selectFromTeacher" target="u"><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											评价教练</span></a></li>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
							...
							<ul>
								<li><a class="submenu"
									href="student/toRreply!getMailInfoByStudentId" target="u"><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											查看回复</span></a></li>
								<li><a class="submenu"
									href="student/toSendMail!clickSendMail" target="u"><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											发送邮件</span></a></li>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
								class="icon-folder-close-alt"></i><span class="hidden-tablet">
									设置</span></a>
							<ul>
								<li><a class="submenu" href="student/toChangePass!init"
									target="u"><i class="icon-file-alt"></i><span
										class="hidden-tablet"> 修改密码</span></a></li>
								<li><a class="submenu" href="student/toAbout!init"
									target="u"><i class="icon-file-alt"></i><span
										class="hidden-tablet"> 关于</span></a></li>
								<li><a class="submenu" href="index.jsp""><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											退出登录</span></a></li>
			...
			<div id="content" class="span10">
				<iframe frameborder="0" src="student/toMain!welcomeToStudent"
					name="u" style="height: 600px;width: 100%"></iframe>
			</div>
			<!--/#content.span10-->
		</div>
		<!--/fluid-row-->
