		...
		<div class="box span12">
			...
			<div class="box-content">
				<form class="form-horizontal"
					action="student/toSendMail!estimateSendMail" method="post">
					<fieldset>
						<div class="control-group">
							<label class="control-label" for="typeahead">收件人</label>
							<div class="controls">
								<input type="text" placeholder="运管信箱" class="span6 typeahead"
						...
						<div class="control-group">
							...
							<div class="controls">
								<label id="time"></label> <input type="hidden"
									name="mail.mail_time" id="timeHidden">
							</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input name="mail.mail_theme" type="text"  class="form-control" required>
							</div>
