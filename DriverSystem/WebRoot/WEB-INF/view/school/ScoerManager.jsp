...
<html>
  <head>
    ...
    <title>My JSP 'ScoerManager.jsp' starting page</title>
...
$(this).children().attr("href","driveSchool/schoolCertified!scoermanage?page="+$(this).children().html());
  ...
  <div class="row-fluid sortable">
		<div class="box span12">
        	...
        	<s:iterator value="eplist" var="li" status="t">
        	 <input type="hidden" name="iput" class="input" value="<s:property value="#li.exam_plan_input"/>"/>
        	<tr>
        	...
        	<td> <a id="input<s:property value="(#t.index)"/>" href="driveSchool/schoolCertified!scoreinput?epid=<s:property value="#li.exam_plan_id"/>">录入/</a> 
        	<a href="driveSchool/schoolCertified!scorecheck?epid=<s:property value="#li.exam_plan_id"/>">查看</a>
        	</td>
        	</tr>
        	</s:iterator>
        	</table>
