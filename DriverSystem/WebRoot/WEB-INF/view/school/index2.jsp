		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
                  ...
                  <a class="brand"><span>驾校平台</span></a>
				<!-- start: Header Menu -->
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown"><a class="btn dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="main/toMain"><i class="halflings-icon off"></i>
										系统退出</a></li>
							</ul></li>
						<!-- end: User Dropdown -->
					</ul>
		...
		<div class="row-fluid">
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
								class="icon-folder-close-alt"></i><span class="hidden-tablet">
									系统管理</span><span class="label label-important"></span></a>
							<ul>
								<li><a class="submenu" href="certificed!certificted"
									target="u"><i class="icon-file-alt"></i><span
										class="hidden-tablet"> 驾校认证</span></a></li>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a class="dropmenu" href="#"><i
							...
							<ul>
								<li><a class="submenu"
									href="driveSchool/schoolCertified!SchoolManagerInfo" target="u"><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											修改个人信息</span></a></li>
								<li><a class="submenu"
									href="driveSchool/schoolCertified!updatePWD" target="u"><i
										class="icon-file-alt"></i><span class="hidden-tablet">
											修改密码</span></a></li>
								<li><a class="submenu" href="#" target="frame2" id="exit"
									onclick="return exit()"><i class="icon-file-alt"></i><span
										class="hidden-tablet"> 退出登录</span></a></li>
			...
			<div id="content" class="span10">
				<iframe frameborder="0" src="driveSchool/toMainPage"
					name="u" style="height: 600px;width: 1100px"></iframe>
			</div>
			<!--/#content.span10-->
		</div>
		<!--/fluid-row-->
