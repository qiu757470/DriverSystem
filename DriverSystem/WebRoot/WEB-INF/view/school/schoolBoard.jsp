...
<script type="text/javascript">
	...
	function checknote(tag) {
		...
		$(tag).attr("href", "driveSchool/Notice!checkNotice?trans_notice_id=" + trans_notice_id);
			...
			<div class="box-content">
				<table class=" table table-hover">
					...
					<%
							int j = 0;
						%>
					<s:iterator value="transhasNoticeList" var="u">

						<tr>
							<td value="#u.trans_notice_id"><%=++j%></td>
