...
var a=$(this).html();
if(a<60&&a!=''){
$("#result"+index).html("不合格");
}else if(a>=60&&a!=''){
$("#result"+index).html("合格");
}else{
$("#result"+index).html("");
}
})
...
$(this).children().attr("href","driveSchool/schoolCertified!scorechecklist?page="+$(this).children().html()+"&"+"epid="+$("#epi").val());
   	...
   	<s:iterator value="examPlanInfo.student" var="info" status="con">
   	 <input name="stu_id" type="hidden" value="<s:property value="#info.student_id"/>"/>
   		<tr>
   			...
   			<td><span class="span" id="score<s:property value="(#con.index)"/>"><s:property value="#info.studentCouse.student_course_score"/></span></td>
   			<td><span id="result<s:property value="(#con.index)"/>"></span></td>
   		</tr>
   	</s:iterator>
   </table>
